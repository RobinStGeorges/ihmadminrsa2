...
import equipementResolve from './equipement-routing-resolve.service';
  ...
  describe('resolve', () => {
    it('should return IEquipement returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        equipementResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
      ...
      expect(resultEquipement).toEqual({ id: 'ABC' });
    });
